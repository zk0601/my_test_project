...
def main(user, passwd):
    ...
    try:
        ...
        button3.click()
        button4 = browser.find_element(By.CSS_SELECTOR, '#fineui_17-inputEl-icon')
        button4.click()
        button_tmp = browser.find_element(By.CSS_SELECTOR, '#fineui_19-inputEl-icon')
        button_tmp.click()
        time.sleep(1)
        button5 = browser.find_element(By.CSS_SELECTOR, '#fineui_22-inputEl-icon')
        button5.click()
        button6 = browser.find_element(By.CSS_SELECTOR, '#fineui_25-inputEl-icon')
        button6.click()
        button7 = browser.find_element(By.CSS_SELECTOR, '#fineui_31-inputEl-icon')
        button7.click()
        button8 = browser.find_element(By.CSS_SELECTOR, '#fineui_27-inputEl-icon')
        button8.click()
        button9 = browser.find_element(By.CSS_SELECTOR, '#fineui_33-inputEl-icon')
        button9.click()
