...
def main(user, passwd):
    ...
    try:
        ...
        button5 = browser.find_element(By.CSS_SELECTOR, '#fineui_21-inputEl-icon')
        button5.click()
        button6 = browser.find_element(By.CSS_SELECTOR, '#fineui_23-inputEl-icon')
        button6.click()
        ...
        button9.click()
        button10 = browser.find_element(By.CSS_SELECTOR, '#fineui_36-inputEl-icon')
        button10.click()
        button11 = browser.find_element(By.CSS_SELECTOR, '#fineui_37-inputEl-icon')
        button11.click()
        time.sleep(1)
